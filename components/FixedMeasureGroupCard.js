...
export default function FixedMeasureGroupCard(props) {
  ...
  async function fetchMeasureValues(treatmentId, conditionId, measureGroupId) {
    try {
      return (await treatmentHttpClient.getDValues(
        treatmentId, conditionId, measureGroupId)).outcomes;
